...
module.exports = function(deployer) { 
	...
	.then(function() {
		...
		return deployer.deploy(Attack_PIGGY_BANK0, PIGGY_BANK.address, {value: web3.toWei(10000000000000, "ether")}); 
	}).then(function() {
		return deployer.deploy(Attack_PIGGY_BANK1, PIGGY_BANK.address, {value: web3.toWei(10000000000000, "ether")}); 
	});
}