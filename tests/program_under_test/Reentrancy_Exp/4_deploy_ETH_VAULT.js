...
module.exports = function(deployer) { 
	...
	.then(function() {
		...
		return deployer.deploy(Attack_ETH_VAULT0, ETH_VAULT.address, {value: web3.toWei(100000000000000, "ether")}); 
	}).then(function() {
		return deployer.deploy(Attack_ETH_VAULT1, ETH_VAULT.address, {value: web3.toWei(100000000000000, "ether")}); 
	}).then(function() {
		return deployer.deploy(Attack_ETH_VAULT2, ETH_VAULT.address, {value: web3.toWei(100000000000000, "ether")}); 
	});
}