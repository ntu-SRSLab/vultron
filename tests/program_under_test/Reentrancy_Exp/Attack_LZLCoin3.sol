...
import "/home/hjwang/Tools/SCFuzzer_Exp/contracts/LZLCoin.sol";

contract Attack_LZLCoin3 {

  LZLCoin public target_contract;

  function Attack_LZLCoin3(address _targetContract) public payable {
  ...
  function() public payable {
    target_contract.eT(this,  10000,  10000);
  }
} 
