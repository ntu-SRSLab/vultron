...
import "/home/osboxes/Develop/vultron/contracts/AdvancedTokenEIC.sol";

contract Attack_AdvancedTokenEIC5 {

  AdvancedTokenEIC public target_contract;

  function Attack_AdvancedTokenEIC5(address _targetContract) public payable {
      target_contract = AdvancedTokenEIC(_targetContract);
  } 
