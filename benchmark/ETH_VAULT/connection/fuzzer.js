...
async function exec_callFun(call, callSequen_cur){
  ...
  console.log("target before:" + target_bal_bf.toString() + "###" + target_bal_sum_bf);
  console.log("target after: " + target_bal_af.toString() + "###" + target_bal_sum_af);
  console.log("attack after-before:" + attack_bal_af.toString() + "###" + attack_bal_bf.toString());
  console.log("attack before - after: " + attack_bal_acc_bf + "###" + attack_bal_acc_af);
