...
import "./CreditDepositBank.sol";

contract Attack_CreditDepositBank3 {

  CreditDepositBank public target_contract;

  function Attack_CreditDepositBank3(address _targetContract) public payable {
